...
const TIPS := [
	...
	"tip: a coil on a machine makes it a switchable valve. logic from there.",
	...
	"tip: static sea on the interuniverse radio is not just static. listen in morse.",
	"tip: the eye's SIZE is its mood. small is safe. huge is not.",
	"tip: elevators beat portals. Big Computer agrees.",
	"the fork is coming.",
