...
const EH_LOG: Array = [
	...
	[79.0, "there were drawings on it. carved. not letters. letters explain themselves eventually. drawings just wait."],
	[90.0, "six of them, in a ring, around a mouth in the stone shaped like a triangle leaning back into the dark. i'll get to the mouth. or i won't."],
	[101.0, "a circle with a dot in it, pouring strands out the bottom. i thought: sun. then i thought: no. suns don't dangle."],
	[112.0, "a hole wearing a ring, drawn by somebody who had clearly seen one and wished they hadn't. i understand that drawing now. i didn't then."],
	[123.0, "a stone die with too many corners. and tall dripping things with the one eye between them -- or the other way round. forty years i've swapped those two. let them be."],
	[134.0, "and a fork. an ordinary table fork. that one frightened me the most, and i could not tell you why. i can. i won't."],
	[144.0, "i told exactly one person. she laughed until she saw my face, and then she never asked me about it again. good woman. better than i deserved."],
	[155.0, "the metal -- i'll call it metal, it would be rude to call it what it was -- was warm on the north side. only the north side. in january."],
	[166.0, "..."],
	[180.0, "hm."],
	[186.0, "funny what a sound can shake loose. i had almost managed a decade without thinking about the latch."],
	[196.0, "i never mentioned a latch before. forget i said latch."],
	[204.0, ""],
	[212.0, "these noodles are done. a man should finish his noodles before doing something foolish. that isn't wisdom, that's just order of operations."],
	[222.0, ""],
	[228.0, "alright. keys. coat. the good flashlight, not the honest one."],
	[236.0, "driving now. the road out east hasn't changed. the dark still starts at the same fence post."],
	[245.0, "i used to drive this stretch angry. now i drive it grateful. same road. the difference was never the road."],
	[255.0, "the turn's grown over. good. things that matter should be inconvenient."],
	[263.0, "walking now. clover's gone. the bees went wherever bees go when nobody holds the lease."],
	[272.0, "and there it is. lower than i remember. patient things settle."],
	[280.0, "i brought the thing i've kept in the coffee tin since before the tin had a purpose. no, i won't say. you'd only go looking for a tin."],
	[291.0, "it fits. of course it fits. it always fit. that was the whole problem."],
	[300.0, "glowing now. not bright. considerate. a light that knows about neighbors."],
	[309.0, "ah."],
	[314.0, "so that's -- hm."],
	[320.0, "...no. no, that part's mine. some things you get to keep just for being the one standing there. this is one of those."],
	[331.0, "and down it goes. slow as a sunset. the dirt just... accepts it. grass folding over like a page."],
	[341.0, "you'd never know. that's the point, i think. you were never supposed to know. i wasn't either. i just happened to be in the field."],
	[352.0, "anyway. the sky out here is very good tonight."],
	[360.0, "...you hear it, don't you. this sound. the one you tuned in for."],
	[368.0, "that's what the field sounded like. the exact moment it showed me. i've been coming out here to listen to it ever since."],
	[380.0, ""]]
