...
func _ready() -> void:
	catalog = [
		...
		{"id": "hyperdrive","tab": "Rocket",   "name": "Hyperdrive",     "cost": {"coins": 9000, "irid": 60, "ultima": 25}, "desc": "SHIP PART. Right-click near a ship to install. Hold H: scream."},
		{"id": "nucengine", "tab": "Rocket",   "name": "Nuclear Engine", "cost": {"coins": 50000, "uranium": 200, "irid": 100, "ultima": 40}, "desc": "SHIP PART. Rocket 2.0 ONLY. Hotter burn, half the thirst -- and strong enough to beat the thing at the edge of the white zone."},
