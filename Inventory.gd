...
func _ready() -> void:
	catalog = [
		...
		{"id": "nucengine", "tab": "Rocket",   "name": "Nuclear Engine", "cost": {"coins": 3000, "uranium": 30, "irid": 15}, "desc": "SHIP PART. Rocket 2.0 ONLY. Hotter burn, half the thirst -- and strong enough to beat the thing at the edge of the white zone."},
		...
		{"id": "rtg",       "tab": "Electric", "name": "Nuclear RTG",    "cost": {"irid": 20, "uranium": 18, "ultima": 4}, "desc": "+2 EU/s forever off uranium decay (an ultima seed starts it)."},
