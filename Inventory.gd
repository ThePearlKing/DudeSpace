...
var items: Dictionary = {
	...
	"ptetra":     {"name": "Pink Tetrahedron",   "color": Color("#ff7ce9")},
	"ctetra":     {"name": "Cyan Tetrahedron",   "color": Color("#55f2ff")},
	"wtetra":     {"name": "White Tetrahedron",  "color": Color("#f2f2f2")},
	...
	"nucengine":  {"name": "Nuclear Engine",   "color": Color("#5aff3a")},
	...
	"bench":       {"name": "Park Bench",     "color": Color("#7a5a34")},
	"nchip":       {"name": "Neuralink Chip", "color": Color("#7bffb0")},
	"grenade":     {"name": "Grenade",        "color": Color("#3a4a3a")},
	"housekit":    {"name": "House Construction Kit", "color": Color("#c9b8a0")},
	"furnkit":     {"name": "Furniture Placer", "color": Color("#7a5a34")},
	"tv":          {"name": "TV",              "color": Color("#7dff9a")},
	"tvbig":       {"name": "Big TV",          "color": Color("#7dff9a")},
	"camtv":       {"name": "Spy Camera",      "color": Color("#7df9ff")},
...
func _ready() -> void:
	catalog = [
		...
		{"id": "jetpack3",  "tab": "Gear",     "name": "Jetpack 3.0",    "cost": {"coins": 12000, "irid": 80, "ultima": 25, "prism": 50}, "desc": "2x Jetpack 2.0: 1000 tank + DOUBLE thrust. Prism-cored."},
		...
		{"id": "ultima_helmet","tab": "Armor", "name": "Ultima Helmet",  "cost": {"ultima": 24, "prism": 18},  "desc": "HEAD. 14% damage off. Crystal-grown."},
		{"id": "ultima_chest","tab": "Armor",  "name": "Ultima Chestplate","cost": {"ultima": 45, "prism": 30}, "desc": "CHEST. 24% damage off. Crystal-grown."},
		{"id": "ultima_legs","tab": "Armor",   "name": "Ultima Leggings","cost": {"ultima": 33, "prism": 24}, "desc": "LEGS. 18% damage off. Crystal-grown."},
		{"id": "ultima_boots","tab": "Armor",  "name": "Ultima Boots",   "cost": {"ultima": 18, "prism": 15},  "desc": "FEET. 10% damage off. Crystal-grown."},
		{"id": "prism_helmet","tab": "Armor",  "name": "Prism Helmet",   "cost": {"prism": 60, "irid": 24},   "desc": "HEAD. 16% damage off. Shader-forged."},
		...
		{"id": "orbitwand", "tab": "Gear",     "name": "Orbit Wand",     "cost": {"coins": 10000, "irid": 40, "ultima": 15, "prism": 30, "circle": 8}, "desc": "Click an animal or enemy: YEET into orbit. F: yeet yourself. An orbit IS a circle."},
		...
		{"id": "hyperdrive","tab": "Rocket",   "name": "Hyperdrive",     "cost": {"coins": 6000, "irid": 60, "ultima": 25}, "desc": "SHIP PART. Right-click near a ship to install. Hold H: scream."},
		{"id": "nucengine", "tab": "Rocket",   "name": "Nuclear Engine", "cost": {"coins": 10000, "uranium": 200, "irid": 100, "ultima": 40}, "desc": "SHIP PART. Rocket 2.0 ONLY. Hotter burn, half the thirst -- and strong enough to beat the thing at the edge of the white zone."},
		...
		{"id": "generator", "tab": "Electric", "name": "Generator",      "cost": {"ingot": 8},   "desc": "Burns coal: 1 coal -> 12 EU."},
		{"id": "coal", "tab": "Electric", "name": "Coal (lump)", "cost": {"coins": 5}, "desc": "One lump. The generator eats it: 1 coal -> 12 EU. No, there is no machine that digs it for free anymore."},
		{"id": "bioreactor","tab": "Electric", "name": "Bioreactor",     "cost": {"ingot": 6, "plantfiber": 6}, "desc": "Meat, plants, bananas, even THE APPLE -> energy."},
		{"id": "housekit", "tab": "Machines", "name": "House Construction Kit", "cost": {"ingot": 10, "plantfiber": 8}, "desc": "Right-click: pick a house type, preview, place. Bigger inside. Much."},
		{"id": "furnkit", "tab": "Machines", "name": "Furniture Placer", "cost": {"ingot": 2, "plantfiber": 4}, "desc": "Reusable. Right-click: bench, chair, sofa, carpet, bed. 2 plantfiber per piece. Humans will sit on all of it."},
		...
		{"id": "tv",    "tab": "Electric", "name": "TV",             "cost": {"ingot": 3, "wire": 4, "coal": 1}, "desc": "Place on any surface -- table, catwalk, floor, house. Against a wall it MOUNTS (no stand). F: cameras, ALIEN NEWS, FORK TV."},
		...
		{"id": "camtv", "tab": "Electric", "name": "Spy Camera",     "cost": {"ingot": 2, "wire": 3}, "desc": "Place it, F to NAME it -- then any TV can watch through it."},
		...
		{"id": "rtg",       "tab": "Electric", "name": "Nuclear RTG",    "cost": {"irid": 40, "uranium": 40, "ultima": 10}, "desc": "+2 EU/s forever off uranium decay (an ultima seed starts it)."},
